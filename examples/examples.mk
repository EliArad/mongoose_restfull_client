SOURCES = $(PROG).c ../../mongoose.c  jWrite.c nxjson.c   AcuteHttpClientApi.c  HttpClientApi.c fifo.c
CFLAGS = -g    -I../.. -Wno-unused-function $(CFLAGS_EXTRA) $(MODULE_CFLAGS)  -lm  -std=gnu99
CFLAGS += -Werror  -W -Wall -Wno-missing-field-initializers  
